...
function add_css() {
	...
	style.id = "svelte-nnslsk-style";
	style.textContent = "section.svelte-nnslsk{margin-top:7rem}.login-card-container.svelte-nnslsk{display:flex;margin:auto;width:23rem;height:30rem;background-color:rgb(0, 173, 223);border:3px solid #737d84;border-radius:25px}.login-header.svelte-nnslsk{max-width:70vw;margin-top:3rem;text-align:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(h2, file, 32, 6, 515);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(p, file, 33, 6, 536);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div0, "class", "login-header svelte-nnslsk");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div0, file, 31, 4, 482);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div1, "class", "login-card-container svelte-nnslsk");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div1, file, 30, 2, 443);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(section, "class", "svelte-nnslsk");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(section, file, 29, 0, 431);
		},
...
class Login extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-nnslsk-style")) add_css();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiI4MmIxN2ExYmUwY2Y4MTJlNjc2Yi9sb2dpbi5sb2dpbi5qcyIsInNvdXJjZXNDb250ZW50IjpbXSwic291cmNlUm9vdCI6IiJ9