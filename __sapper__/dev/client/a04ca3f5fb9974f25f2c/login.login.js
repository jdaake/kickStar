...
function add_css() {
	...
	style.id = "svelte-or3msj-style";
	style.textContent = "section.svelte-or3msj{margin-top:7rem}.login-card-container.svelte-or3msj{display:flex;margin:auto;width:23rem;height:30rem;background-color:rgba(0, 173, 223, 0.2);border:3px solid #737d84;border-radius:25px}.login-header.svelte-or3msj{max-width:70vw;margin-top:3rem;text-align:center}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(h2, file, 33, 6, 522);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(p, file, 34, 6, 543);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div0, "class", "login-header svelte-or3msj");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div0, file, 32, 4, 489);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div1, "class", "login-card-container svelte-or3msj");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div1, file, 31, 2, 450);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(section, "class", "svelte-or3msj");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(section, file, 30, 0, 438);
		},
...
class Login extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-or3msj-style")) add_css();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhMDRjYTNmNWZiOTk3NGYyNWYyYy9sb2dpbi5sb2dpbi5qcyIsInNvdXJjZXNDb250ZW50IjpbXSwic291cmNlUm9vdCI6IiJ9