...
function add_css() {
	...
	style.id = "svelte-om0b0v-style";
	style.textContent = "section.svelte-om0b0v{display:flex;margin:auto;width:50vw}.login-card-container.svelte-om0b0v{display:flex;margin-top:6rem;width:23rem;height:30rem;background-color:rgb(0, 173, 223);border-radius:25px}.login-header.svelte-om0b0v,.login-username.svelte-om0b0v{max-width:80vw;display:inline;display:block}\n/*# sourceMappingURL=data:application/json;charset=utf-8;base64, */";
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div0, "class", "login-header svelte-om0b0v");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div1, "class", "login-username svelte-om0b0v");
			...
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(div3, "class", "login-card-container svelte-om0b0v");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["add_location"])(div3, file, 32, 2, 462);
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr_dev"])(section, "class", "svelte-om0b0v");
...
class Login extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponentDev"] {
	constructor(options) {
		super(options);
		if (!document.getElementById("svelte-om0b0v-style")) add_css();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIzYzRjMzM3N2QzZjM0OGQyZjVjOS9sb2dpbi5sb2dpbi5qcyIsInNvdXJjZXNDb250ZW50IjpbXSwic291cmNlUm9vdCI6IiJ9